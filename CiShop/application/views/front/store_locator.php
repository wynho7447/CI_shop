...
<script type="text/javascript" src="<?php echo base_url(); ?>template/front/assets/js/mapcluster.js"></script>

<div class="breadcrumbs">
    <div class="container">
        <h1 class="pull-left"><?php echo translate('our_vendors');?></h1>
    </div>
</div>
    ...
    <div class="row margin-bottom-60">
        ...
        <div class="col-md-4 col-sm-4">
            <div class="input-group animated fadeInDown">
                <input type="text" class="form-control" value="<?php echo $text; ?>" placeholder="<?php echo translate('search_vendors');?>" onkeyup="search_loc()" 
                id="search">
                <span class="input-group-btn">
                    <button class="btn-u" type="button"><?php echo translate('go'); ?></button>
                </span>
            </div>
            <div class="col-md-12 col-sm-12">
            	<div class="row">
                    <div class="panel panel-purple margin-bottom-40" style="margin-top:10px !important;">
                        ...
                        <div class="panel-body" id="result" style="height:415px; overflow:auto; padding-top:0px !important;">
    ...
    function search_loc(){
        ...
        for (i = 0; i < sale_details_new.length; i++) {
            res += ''
                ...
                +'<h3>'+sale_details_new[i][3]+'</h3></a>'
                +'<p>'+sale_details_new[i][0]+'</p>'
                +'<p>'+sale_details_new[i][4]+'</p>'
                +'<p>'+sale_details_new[i][5]+'</p>'
