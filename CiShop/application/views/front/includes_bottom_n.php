...
<script type="text/javascript" src="<?php echo base_url(); ?>template/front/assets/plugins/dropdown/js/jquery.dropdown.js"></script>
<!--Chosen [ OPTIONAL ]-->
...
?>
<audio style="display:none;" preload="none" class="audio_set" id='<?php echo $row; ?>' ><source type="audio/mpeg" data-src="<?php echo base_url(); ?>uploads/audio/home/<?php echo $row; ?>.mp3"></audio>
<?php
        }
    }
?>
