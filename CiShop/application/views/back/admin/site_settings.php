                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                ?>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label"><?php echo translate('category_menu_slider');?></label>
                                        <div class="col-sm-6">
                                            <input id="set_slides" class='sw4' data-set='set_slides' type="checkbox" <?php if($this->crud_model->get_type_name_by_id('general_settings','62','value') == 'ok'){ ?>checked<?php } ?> />
                                        </div>
                                    </div>
                                    <div class="form-group">
